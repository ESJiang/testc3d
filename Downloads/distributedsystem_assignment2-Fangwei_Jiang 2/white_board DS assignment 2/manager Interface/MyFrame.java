...
public class MyFrame extends JFrame 
{
    ...
    public static String fontName = new String("Times New Roman");
    ...
    public void init(String s) 
    {
        ...
        this.addWindowListener(new WindowAdapter() 
        {
            ...
            public void windowClosing(WindowEvent e) 
            {
                if (saved == 0) 
                {
                    int n = JOptionPane.showConfirmDialog(null, "You haven't back up, Do you want to exit?", "Confirm", 1);
                    if (n == 0)
                    {
                        System.exit(0);
                    }
    ...
    class MyMenu {
        ...
        public void addMenu() {
            ...
            set_menu = new JMenu("Setting");
            help_menu = new JMenu("Help");
            stroke_menu = new JMenu("Thick/Thin");
            // 实例化菜单项,并通过ImageIcon对象添加图片
            file_item_new = new JMenuItem("New", new ImageIcon(getClass().getResource("/image/new.png")));
            file_item_open = new JMenuItem("Open", new ImageIcon(getClass().getResource("/image/open.png")));
            file_item_save = new JMenuItem("Save", new ImageIcon(getClass().getResource("/image/save.png")));
            file_item_exit = new JMenuItem("Quit", new ImageIcon(getClass().getResource("/image/exit.png")));
            set_item_color = new JMenuItem("Color", new ImageIcon(getClass().getResource("/image/color.png")));
            set_item_undo = new JMenuItem("Undo", new ImageIcon(getClass().getResource("/image/undo.png")));
            help_item_use = new JMenuItem("Manual");
            help_item_info = new JMenuItem("Group Description");
            for (int i = 0; i < 4; i++) {
            ...
            // 设置快捷键
            int ctrlMask = CTRL_MASK;
            file_item_new.setAccelerator(getKeyStroke(KeyEvent.VK_N, ctrlMask));
            file_item_open.setAccelerator(getKeyStroke(KeyEvent.VK_O, ctrlMask));
            file_item_save.setAccelerator(getKeyStroke(KeyEvent.VK_S, ctrlMask));
            file_item_exit.setAccelerator(getKeyStroke(KeyEvent.VK_X, ctrlMask));
            set_item_undo.setAccelerator(getKeyStroke(KeyEvent.VK_Z, ctrlMask));
            // 添加粗细子菜单
